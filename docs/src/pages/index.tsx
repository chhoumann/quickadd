...
const FeatureList: FeatureItem[] = [
	{
		...
		description: (
			<>
				Capture thoughts, ideas, and information instantly. No more context
				switching - just hit your hotkey and start typing.
			</>
		),
	},
	{
	...
	},
	{
		...
		description: (
			<>
				Regular updates, active community, and continuous improvements. Your
				feedback shapes the future of QuickAdd.
			</>
		),
	},
];
		...
		<header className={clsx("hero", styles.heroBanner)}>
			<div className="container">
				...
				<div className={styles.buttons}>
					<Link className="button hero-button hero-button--primary" to="/docs/">
						Get Started →
					</Link>
					<Link
				...
				<div className="row">
					<div className="col col--6">
						<div className="feature-card">
							<h3>📚 Book Database</h3>
							<p>
								Automatically create book notes with metadata fetched from APIs.
								Add ratings, quotes, and reading progress with a single command.
							</p>
					...
					<div className="col col--6">
						<div className="feature-card">
							...
							<p>
								Capture journal entries with timestamps, mood tracking, and
								weather data. Never miss a day with automated prompts.
							</p>
							<Link to="/docs/Examples/Capture_AddJournalEntry">
								Learn how →
							</Link>
						</div>
					</div>
				...
				<div className="row margin-top--md">
					<div className="col col--6">
						<div className="feature-card">
							<h3>🎬 Media Tracker</h3>
							<p>
								Track movies and TV shows with automatic metadata. Create
								watchlists, reviews, and recommendations.
							</p>
							<Link to="/docs/Examples/Macro_MovieAndSeriesScript">
								Learn how →
							</Link>
						</div>
					</div>
					<div className="col col--6">
						<div className="feature-card">
							...
							<p>
								Integrate with Todoist, create Kanban boards, and manage
								projects. Turn Obsidian into your productivity hub.
							</p>
							<Link to="/docs/Examples/Capture_AddTaskToKanbanBoard">
								Learn how →
							</Link>
						</div>
					</div>
				...
				<div className="row">
					<div className="col col--4">
						<div className="text--center">
							...
							<p>
								Find QuickAdd in Obsidian's Community Plugins browser and enable
								it.
							</p>
						</div>
					</div>
					...
					<div className="col col--4">
						<div className="text--center">
							...
							<p>
								Trigger QuickAdd with Cmd/Ctrl+P and select your choice. That's
								it!
							</p>
						</div>
					</div>
