---
title: QuickAdd API
description: "Full reference for the QuickAdd API: input prompts, suggesters, file operations, AI prompts and agents, and choice execution"
...
[API Overview](/docs/Advanced/APIOverview/) first. This page is the full reference.
...
**Keyboard:** Pressing **Tab** inserts a tab character at the cursor (handy for nested Markdown lists) instead of moving focus; with text selected, Tab indents every line the selection touches. **Shift+Tab** still moves focus out of the field. See [multi-line input](/docs/FormatSyntax/#value-multiline).
...
- [Macro Choices](/docs/Choices/MacroChoice/) - Using scripts in macros
- [Inline Scripts](/docs/InlineScripts/) - Using scripts in templates
- [Format Syntax](/docs/FormatSyntax/) - Template variables
- [Examples](/docs/Examples/Macro_BookFinder/) - Practical implementations
