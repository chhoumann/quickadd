 ...
 */
export function isAppendLinkOptions(
	appendLink: boolean | AppendLinkOptions
): appendLink is AppendLinkOptions {
	return (
 ...
 */
export function normalizeAppendLinkOptions(
	appendLink: boolean | AppendLinkOptions
): AppendLinkOptions {
 ...
 */
export function isAppendLinkEnabled(
	appendLink: boolean | AppendLinkOptions
): boolean {
