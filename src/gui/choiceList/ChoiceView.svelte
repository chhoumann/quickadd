<script lang="ts">
    ...
    export let choices: Choice[] = [
        ...
        <MultiChoice>{name: '📥 Add...', type: ChoiceType.Multi, id: uuidv4(), collapsed: false, choices: [
        ...
        <MultiChoice>{name: '🌀 Task Manager', type: ChoiceType.Multi, id: uuidv4(), collapsed: false, choices: [
    ...
    export let saveChoices: (choices: Choice[]) => void;
</script>
