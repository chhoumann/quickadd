...
// and a case transform. A case transform is recognized only as the token's
// terminal option, so an earlier `|case:...|` remains part of the Moment format.
// Literal pipes elsewhere are still rendered verbatim
